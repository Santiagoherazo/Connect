    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-white flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-zinc-100 p-6">
          <h2 className="text-lg font-semibold text-zinc-800 mb-5">Entrar a tu cuenta</h2>

          <Button onClick={handleGoogle} loading={googleLoading} variant="secondary" size="lg" className="w-full mb-4">
            <GoogleIcon />
          ...
          <p className="text-center text-xs text-zinc-400 mt-4">
            ¿No tienes cuenta?{' '}
            <Link href="/signup" className="text-teal-600 font-medium hover:underline">Regístrate gratis</Link>
          </p>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative my-4">
      ...
      <div className="relative flex justify-center">
        <span className="bg-white px-3 text-xs text-zinc-400">o con email</span>
      </div>
    </div>
  )
}
